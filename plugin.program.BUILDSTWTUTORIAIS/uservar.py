...
ADDONTITLE     = '[B][COLOR white].[COLOR mediumblue]WIZARD [COLOR lime]BUILDS [COLOR yellow]TWTUTORIAIS [COLOR white][/COLOR][/B]'
BUILDERNAME    = 'WIZARD BUILDS TWTUTORIAIS'
#########################Make sure to change the repo to yours!!!!
EXCLUDES       = [ADDON_ID, 'roms', 'My_Builds', 'backupdir']
BUILDFILE      = 'https://raw.githubusercontent.com/REPOTONYWARLLEY/MEGAREPO2/refs/heads/master/2026/wizard'
UPDATECHECK    = 0
APKFILE        = 'http://'
YOUTUBETITLE   = 'FuckYouTube' 
YOUTUBEFILE    = 'http://'
ADDONFILE      = 'http://'
ADVANCEDFILE   = 'http://'
ROMPACK        = 'http://'
...
HIGHLIGHT_LIST = 'list_button_focus'
...
WIZTITLE = 'WIZARD BUILDS TWTUTORIAIS'
...
NOTIFICATION   = 'https://raw.githubusercontent.com/REPOTONYWARLLEY/MEGAREPO2/refs/heads/master/2026/MENSAGEWIZARD3'
# Use either 'Text' or 'Image'
HEADERTYPE     = 'Text'
# Font size of header
FONTHEADER     = 'Font13'
HEADERMESSAGE  = 'WIZARD BUILDS TWTUTORIAIS'
# url to image if using Image 424x180
HEADERIMAGE    = 'WIZARD BUILDS TWTUTORIAIS'
